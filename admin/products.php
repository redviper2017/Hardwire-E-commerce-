...
if ($_POST) {
	...
	if (!empty($_FILES)) {
		...
		$dbpath = '/New Project/images/products/'.$uploadName;
		if ($mimeType!='image') {
	...
	if (!empty($errors)) {
		...
		$insertSql = "INSERT INTO products (`title`,`price`,`list_price`,`brand`,`categories`,`sizes`,`image`) 
		VALUES ('$title','$price','$list_price','$brand','$categories','$sizes','$dbpath')";
		$db->query($insertSql);
...
?>
 ...
 <form action="products.php?add=1" method="POST" enctype="multipart/form-data">
 	...
 	<div class="form-group pull-right">
 		<input type="submit" value="Add Product" class="form-control btn btn-success" name="">
		...
		?>
			<tr>
				<td>
					...
					<a href="products.php?delet=<?=$product['id'];?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-remove"></span></a>
				</td>
				<td><?=$product['title'];?></td>
